...
function runMacroOptimizerTests() {
  // Cenário VIÁVEL no modelo v049: contrapartida econômica (SENAI) dentro do teto de cada macro.
...
console.log('OK: regras de contribuição, multi-macro, reversão, inteiros e exportação v049.');
